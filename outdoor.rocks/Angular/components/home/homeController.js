    ...
    .controller('HomeCtrl', ['$scope', '$http', '$state', function ($scope, $http, $state) {
        ...
        function loadTrails() {
            ...
            .success(function (response) {                
                ...
                var searchModel = [];
                $scope.trails.forEach(function (i) {
                    searchModel.push(
                    {
                        "id": i._id,
                        "name": i.Name,
                ...
                $scope.regionsAndTrailsModel = searchModel;
